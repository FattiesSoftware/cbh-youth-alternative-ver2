...
<div class='navbar-header'>
  <!--Logo của trang-->
	<a href='/'>
	<img src="/images/cbh.png" class="logo2" style="width: 40px;height: 40px;margin-top: 5px;margin-right: 5px;margin-left: 5px;" alt="">
</a>
...
<li class="<?=$tracuu?>"><a class="nav-link dropdown-toggle" href="/tracuu" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-search"></i> Tra cứu</a>
		  ...
		  <a class="dropdown-item " style="margin-left: 10px;" href="/loivipham"><i class="fas fa-times"></i> Các lỗi vi phạm</a><br>
          <a class="dropdown-item " style="margin-left: 10px;" href="/thoikhoabieu"><i class="fas fa-table"></i> Thời khoá biểu</a><br>
          <a class="dropdown-item " style="margin-left: 10px;" href="/hocsinh"><i class="fas fa-user-graduate"></i> Học sinh</a>
        </div></li>
...
<li style="display:<?=$IN?>"><a href='/login'><i class="fas fa-sign-in-alt"></i> Đăng nhập</a></li>
<li style="display:<?=$OUT?>"><a href='/logout.php'><i class="fas fa-sign-in-alt"></i> Đăng xuất</a></li>
</ul>
</div>
</div>
</nav>
